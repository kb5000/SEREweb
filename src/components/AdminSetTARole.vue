  ...
  <div class="">
    ...
    <div class="gridCommon">
        ...
        <el-form-item label="设置角色">
            <el-select v-model="form.category" placeholder="请设置助教角色">
            <el-option label="助教" :value="true"></el-option>
            <el-option label="非助教" :value="false"></el-option>
            </el-select>
        </el-form-item>
        <el-form-item>
        ...
        axios.post('/api', 'method=get&key=class.' + this.form.courseid).then(res => {
          if (res.data == null) {
            ...
            if (this.form.category) {
              axios.post('/api', 'method=setj&key=class.' + this.form.courseid + '.ta.' + this.form.teacherid + '&val=true');
            } else {
              axios.post('/api', 'method=erase&key=class.' + this.form.courseid + '.ta.' + this.form.teacherid);
            }
          }
        })
        // console.log('submit!');
